...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TUSCUSA Engagement Platform" },
      { name: "description", content: "TUSCUSA — a youth engagement platform for member registry, voting, funding transparency, and opportunities." },
      { property: "og:title", content: "TUSCUSA Engagement Platform" },
      { property: "og:description", content: "TUSCUSA — a youth engagement platform for member registry, voting, funding transparency, and opportunities." },
